...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    title: "행정",
    items: [
      { id: "academy", icon: <Building size={18} />, label: "학원 교습소 정보", href: "/my/vip/academy" },
      { id: "school-info", icon: <Location size={18} />, label: "학교 정보 관리", href: "/my/vip/school-info" },
      { id: "forms", icon: <Template size={18} />, label: "학원 양식 관리", href: "/my/vip/forms" },
      { id: "inventory", icon: <Box size={18} />, label: "재고 관리", href: "/my/vip/inventory" },
      { id: "expenses", icon: <Receipt size={18} />, label: "운영비 관리", href: "/my/vip/expenses" },
      { id: "payroll", icon: <Wallet size={18} />, label: "급여 관리", href: "/my/vip/payroll" },
    ],
  },
  {
    title: "도구",
