#!/usr/bin/env python3
"""Windows CUDA 주장 LoRA 추론: 지문 → question_data JSON (stdout). Claude/API 없음.

Mac ml/claim/infer.py 와 동일한 stdout 계약:
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Local claim-variant infer (Windows CUDA LoRA)")
