"""빈칸(blank) 어댑터 경로 상수 + 공용 런타임(ml/common/cuda_runtime.py) 재수출.
...
DEFAULT_ADAPTER = _TYPE_DIR / "adapters" / "blank-lora"
DEFAULT_EXPLAIN_ADAPTER = _TYPE_DIR / "adapters" / "blank-explain-lora"
