"""Shared CUDA model load + chat generate for Windows title LoRA."""
...
from _title_common import extract_json_object  # noqa: E402

DEFAULT_ADAPTER = _TYPE_DIR / "adapters" / "title-lora-cuda"
DEFAULT_EXPLAIN_ADAPTER = _TYPE_DIR / "adapters" / "title-explain-lora-cuda"
...
def load_model(
    ...
    try:
        ...
        raise RuntimeError(
            f"transformers/peft missing ({e}). Run ml\\title\\windows\\setup.bat"
        ) from e
